...
and skips "Paris". Store the other cities in a new array named visitedCities. :use 'continue' keyword
*/
...
// console.log(worldCities["Berlin"]);
let largeCities = {};
...
let availableTeas = [];
teaTypes.forEach(function (tea) {  // ForEach dosen't support break or continue.
    if (tea === "chai") {
        return;
    }
